const Works = [
  {
    ...
    title: "ChipTranz",
    description:
      "ChipTranz is an android mobile app used to save funds, I designed and built this product with simplicity in mind and while giving priority to a smooth UI/UX experience for the users ",
    image:
      "https://res.cloudinary.com/bundayy/image/upload/v1584523007/portfolio/Screen_Shot_2020-01-13_at_11.22.58_AM_rntehq.png",
    tech: ["Ionic", "Tailwind", "Firebase", "Capacitor"],
    link:
      "https://play.google.com/store/apps/details?id=com.wavyscript.chiptranz"
  },
  {
    id: 2,
    title: "Frannies Luxury Shop",
    description:
      "Frannies Luxury Shop is an online store which was built to the satisfaction of the owner, I kept the design simple while " +
      "selling the products to the customer. It is integrated wiith a payment system, an investory system, an order management system and also a delivery " +
      "management system which manages the whole customers",
    image:
      "https://res.cloudinary.com/bundayy/image/upload/v1584523095/portfolio/Screen_Shot_2020-03-18_at_10.18.04_AM_jxh3hl.png",
    tech: ["Wordpress", "Bootstrap", "Paystack"],
    link: "https://franniesluxuryshop.com/"
  },
  {
    id: 3,
    title: "Cyclotron Engineering Service",
    description:
      "Cyclotron is an engineering company portfolio website, colors and deisgns were choosen based on the clients request and was delivered within a short period.",
    image:
      "https://res.cloudinary.com/bundayy/image/upload/v1584523777/portfolio/cyclon_lkt8tl.png",
    tech: ["Wordpress", "Bootstrap"],
    link: "http://cyclotroneng.com/"
  },
  {
    id: 4,
  ...
  },
  {
    ...
    link: "http://pgsui.com/pgdev/public"
  }
];
